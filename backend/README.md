...
## Project Structure
    ...
    ├── throbbing_forest_de_67314  # Django project configurations
...
1. Clone this repo and `cd throbbing_forest_de_67314`
...
2. Clone this repo and `cd throbbing_forest_de_67314`
